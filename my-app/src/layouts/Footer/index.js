        ...
        <>
         <div className={cx("bg")}>
            <div className={cx("col-content")}>
                ...
                <div className={cx("link-content")}>
                    <h4>Tổng đài</h4>
                    <a className={cx("hotline" )}>1900.2091</a>
                </div>
                ...
                <div className={cx("list-pay")}>
                    ...
                    <ul className={cx("list-logo")}>
                        <li className={cx("subLogo")}>
                            <img style={{marginRight:5}}src="https://hoanghamobile.com/Content/web/img/logo-visa.png" />
                            <img src="https://hoanghamobile.com/Content/web/img/logo-master.png" />
                        </li>
                        <li className={cx("subLogo")}>
                            <img style={{marginRight:5}} src="https://hoanghamobile.com/Content/web/img/logo-jcb.png" />
                            <img src="https://hoanghamobile.com/Content/web/img/logo-samsungpay.png" />
                        </li>
                        <li className={cx("subLogo")}>
                            <img style={{marginRight:5}} src="https://hoanghamobile.com/Content/web/img/logo-atm.png" />
                ...
                <div className={cx("list-transport")}>
                    ...
                    <ul className={cx("list-logo")}>
                        <li>
                            <img style={{marginRight:5}} src="https://hoanghamobile.com/Content/web/img/nhattin.jpg" />
